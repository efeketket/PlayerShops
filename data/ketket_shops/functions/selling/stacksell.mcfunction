...
data modify entity @e[type=item,tag=selleditem,sort=nearest,limit=1] Item set from entity @e[type=item_display,tag=shopdata,sort=nearest,limit=1] item.tag.Product
