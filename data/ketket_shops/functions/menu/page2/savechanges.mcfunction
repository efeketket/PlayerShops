...
execute as @s if data block ~ ~ ~ Items[{Slot:15b}] unless data block ~ ~ ~ Items[{Slot:15b,tag:{ketket_shop:1b}}] run function ketket_shops:menu/page2/modification/updateprice
