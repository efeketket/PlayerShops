...
execute as @s[tag=!setup] unless data block ~ ~ ~ {Items:[{Slot:26b,id:"minecraft:lime_dye",tag:{ketket_shop:1b}}]} run function ketket_shops:menu/page2/savechanges
execute as @s[tag=!setup] unless data block ~ ~ ~ {Items:[{Slot:0b,id:"minecraft:arrow",tag:{ketket_shop:1b}}]} run function ketket_shops:menu/modification/pageswitch
execute as @s[tag=!setup] unless data block ~ ~ ~ {Items:[{Slot:8b,id:"minecraft:brush",tag:{ketket_shop:1b}}]} run function ketket_shops:menu/modification/clearcache
