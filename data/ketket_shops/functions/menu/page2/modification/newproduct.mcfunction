...
execute if data block ~ ~ ~ Items[{Slot:11b}] run data modify entity @e[type=item_display,sort=nearest,limit=1,tag=shopdata] item.tag.Product set from block ~ ~ ~ Items[{Slot:11b}]
execute if data block ~ ~ ~ Items[{Slot:12b}] run data modify entity @e[type=item_display,sort=nearest,limit=1,tag=shopdata] item.tag.Product set from block ~ ~ ~ Items[{Slot:12b}]
execute if data block ~ ~ ~ Items[{Slot:13b}] run data modify entity @e[type=item_display,sort=nearest,limit=1,tag=shopdata] item.tag.Product set from block ~ ~ ~ Items[{Slot:13b}]

execute if data block ~ ~ ~ Items[{Slot:20b}] run data modify entity @e[type=item_display,sort=nearest,limit=1,tag=shopdata] item.tag.Product set from block ~ ~ ~ Items[{Slot:20b}]
execute if data block ~ ~ ~ Items[{Slot:21b}] run data modify entity @e[type=item_display,sort=nearest,limit=1,tag=shopdata] item.tag.Product set from block ~ ~ ~ Items[{Slot:21b}]
execute if data block ~ ~ ~ Items[{Slot:22b}] run data modify entity @e[type=item_display,sort=nearest,limit=1,tag=shopdata] item.tag.Product set from block ~ ~ ~ Items[{Slot:22b}]
...
execute if score @s product_countholder matches 0 store result entity @e[type=item_display,sort=nearest,limit=1,tag=shopdata] item.tag.Product.Count byte 1 run scoreboard players get @s product_count
