...
execute as @s[tag=page1,tag=setup] unless data block ~ ~ ~ Items[{Slot:22b}] if score @e[tag=playershop,tag=interaction,sort=nearest,limit=1,distance=..0.5] currentstock matches 1.. run tag @s add emptying
...
execute unless block ~ ~ ~ minecraft:chest run function ketket_shops:menu/removemenu
