execute as @s[x_rotation=60..90] run summon minecraft:marker ^ ^1.4 ^0 {Tags:["1","detector","east"]} 
execute as @s[x_rotation=60..90] run summon minecraft:marker ^ ^1.4 ^1 {Tags:["2","detector","east"]} 
execute as @s[x_rotation=60..90] run summon minecraft:marker ^ ^1.5 ^2 {Tags:["3","detector","east"]} 
execute as @s[x_rotation=60..90] run summon minecraft:marker ^ ^1.5 ^3 {Tags:["4","detector","east"]} 
execute as @s[x_rotation=60..90] run summon minecraft:marker ^ ^1.6 ^4 {Tags:["5","detector","east"]} 
execute as @s[x_rotation=60..90] run summon minecraft:marker ^ ^1.6 ^5 {Tags:["6","detector","east"]} 

execute as @s[x_rotation=50..60] run summon minecraft:marker ^ ^1.9 ^0 {Tags:["7","detector","east"]} 
execute as @s[x_rotation=50..60] run summon minecraft:marker ^ ^1.9 ^1.2 {Tags:["8","detector","east"]} 
execute as @s[x_rotation=50..60] run summon minecraft:marker ^ ^1.9 ^2.2 {Tags:["9","detector","east"]} 
execute as @s[x_rotation=50..60] run summon minecraft:marker ^ ^1.9 ^3.2 {Tags:["10","detector","east"]} 
execute as @s[x_rotation=50..60] run summon minecraft:marker ^ ^1.9 ^4.2 {Tags:["11","detector","east"]} 
execute as @s[x_rotation=50..60] run summon minecraft:marker ^ ^1.9 ^5.2 {Tags:["12","detector","east"]} 
...
execute as @s[x_rotation=-90..-60] run summon minecraft:marker ^ ^1.4 ^0 {Tags:["25","detector","east"]} 
execute as @s[x_rotation=-90..-60] run summon minecraft:marker ^ ^1.4 ^1 {Tags:["26","detector","east"]} 
